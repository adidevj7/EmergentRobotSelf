...
walk only - i just renamed the file Training_ObsCollection_Scripts/Isaac_TrainingLauncher.py -test
CUDA_VISIBLE_DEVICES=0 ./isaaclab.sh -p CORRECTPATH/Training_ObsCollection_Scripts/Isaac_TrainingLauncher.py \
    --task Ant-Walk-v0   --gym_env_id Isaac-Ant-Direct-v0   --cfg_yaml /home/adi/projects/CreativeMachinesAnt/Isaac/cfg/rlg_walk_new_150_relu.yaml \
    --player_yaml /home/adi/projects/CreativeMachinesAnt/Isaac/cfg/rlg_play_sac_ant_150_relu.yaml   --num_envs 8192   --n_cycles 1 \
    --phase_order walk   --updates_per_step 32   --plateau_min_steps 250_000_000   --max_steps_phase 1_500_000_000 \
    --override_warmup_steps 10000   --log_interval_s 30   --headless  --lambda_back 1  --gpu 0 \
    --record_every 0   --video_gpu 6   --video_wait_pct 50   --video_wait_s 30   --run_tag WSJ_att69_WalkOnly_relu_1 --ckpt_label WSJ_att69_WalkOnly_relu_1 --seed 1
...
CUDA_VISIBLE_DEVICES=0 ./isaaclab.sh -p /home/adi/projects/CreativeMachinesAnt/Isaac/scripts/Isaac_WSJ_att69_cleanup.py \
    ...
    --phase_order walk   --updates_per_step 32   --plateau_min_steps 250_000_000   --max_steps_phase 1_500_000_000 \
    --override_warmup_steps 10000   --log_interval_s 30   --headless  --lambda_back 1  --gpu 0 \
    --record_every 0   --video_gpu 6   --video_wait_pct 50   --video_wait_s 30   --run_tag WSJ_att69_WalkOnly_relu_x --ckpt_label WSJ_att69_WalkOnly_relu_x --seed x
...
CUDA_VISIBLE_DEVICES=0 ./isaaclab.sh -p /home/adi/projects/CreativeMachinesAnt/Isaac/Training_ObsCollection_Scripts/Isaac_TrainingLauncher.py \
  ...
  --plateau_min_steps 250_000_000 --max_steps_phase 1_500_000_000 \
  ...
  --run_tag test4 --ckpt_label test4 --seed 0

  cd /workspace/IsaacLab && \
./isaaclab.sh -p /home/adi/projects/CreativeMachinesAnt/Isaac/Training_ObsCollection_Scripts/Isaac_TrainingLauncher.py \
  --task Ant-Walk-v0 --gym_env_id Isaac-Ant-Direct-v0 \
  --cfg_yaml /home/adi/projects/CreativeMachinesAnt/Isaac/Training_ObsCollection_Scripts/cfg/rlg_walk_new_150_relu.yaml \
  --player_yaml /home/adi/projects/CreativeMachinesAnt/Isaac/Training_ObsCollection_Scripts/cfg/rlg_play_sac_ant_150_relu.yaml \
  --num_envs 8192 --n_cycles 2 --phase_order walk --updates_per_step 32 \
  --plateau_min_steps 250_000_000 --max_steps_phase 1_500_000_000 \
  --override_warmup_steps 10000 --log_interval_s 30 --headless --lambda_back 1 \
  --gpu 0 --record_every 0 \
  --run_tag test3 --ckpt_label test3 --seed 0
